...
_MSG_POKEMON_CARD = (
    "寶可夢卡牌在日本採抽選／限量販售，官方通路開賣即完售，我們無法保證取得。"
    "為了不讓你先付款再被取消，這類商品目前不開放代購。"
    "若你有特定卡種需求，歡迎用 LINE @544kaytb 詢問現貨。"
)
...
_MSG_BEYBLADE = (
    ...
    "開賣即完售，我們無法保證取得。不過同款商品在 Amazon、樂天、Yodobashi "
    "這些通路多半買得到 —— 麻煩你改貼那邊的商品連結，我們照常代購。"
)
...
_MSG_ICHIBAN = (
    ...
    "若你想要特定賞品，可以貼 Mercari、Yahoo 拍賣、駿河屋這些二手平台的現貨連結，"
    "那些我們照常代購。"
)
...
_MSG_ONEPIECE = (
    "航海王卡牌採限量／抽選販售，官方通路無法穩定取得，目前不開放代購。"
    "歡迎用 LINE @544kaytb 詢問現貨。"
)
